...
{
    internal class ByteGreaterThanOrEqualsRule : IRule
    {
        public ByteGreaterThanOrEqualsRule(byte value, byte compareTo, bool validateEquals, bool greaterThan, string notificationKey, string notificationMessage)
        {
            _value = value;
