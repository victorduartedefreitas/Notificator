namespace Notificator.Validations.Rules
{
    ...
    {
        public DecimalGreaterThanOrEqualsRule(decimal value, decimal compareTo, bool validateEquals, bool greaterThan, string notificationKey, string notificationMessage)
        {
            _value = value;
